    ...
    <section class="panel" style="margin-bottom:20px;">
        ...
        <div class="panel-body" style="border-top: 1px solid #eee; padding:15px; background:white;">
            <div class="row" style="margin-right:-15px; margin-left:-15px;">
                ...
                <div class="col-md-12">
                    <form action="{{ route('operator.reviewer.post') }}" enctype="multipart/form-data" method="POST">
                        {{ csrf_field() }} {{ method_field('POST') }}
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="fakultas" value="{{ old('fakultas') }}" id="fakultas" class="form-control">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="prodi" value="{{ old('prodi') }}" id="prodi" class="form-control">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="universitas" value="Universitas Bengkulu" readonly id="universitas" class="form-control">
