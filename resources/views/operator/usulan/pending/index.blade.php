                                            ...
                                            @foreach ($pengabdians as $pengabdians)
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width:40% !important;">
                                                        ...
                                                        <a href="{{ route('operator.pending.detail',[$pengabdians->id,\Illuminate\Support\Str::slug($pengabdians->judul_kegiatan)]) }}" id="selengkapnya">selengkapnya</a>
                                                        <br>
                                                        <hr style="margin-bottom:5px !important; margin-top:5px !important;">
                                                   ...
                                                   <td>
                                                        <a href="{{ asset('storage/'.$pengabdians->file_usulan) }}" download="{{ $pengabdians->file_usulan }}" class="btn btn-primary btn-sm"><i class="fa fa-download"></i></a>
                                                   </td>
                                                    <td style="text-align:center;">
