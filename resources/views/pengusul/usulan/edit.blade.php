            ...
            <div class="row" style="margin-right:-15px; margin-left:-15px;">
                <div class="col-md-12">
                    <div class="alert alert-primary alert-block text-center" id="keterangan">
                        ...
                        <strong class="text-uppercase"><i class="fa fa-info-circle"></i>&nbsp;Perhatian: </strong><br> Silahkan ubah usulan anda jika diperlukan setelah itu klik tombol simpan perubahan. <br>
                        Judul kegiatan anda yang ingin diubah adalah "<b>{{ $usulan->judul_kegiatan }}</b>"
                    </div>
                </div>
                <div class="col-md-12">
                    <a href="{{ route('pengusul.usulan') }}" class="btn btn-danger btn-sm"><i class="fa fa-arrow-left"></i>&nbsp; Kembali</a>
                </div>
                <form action="{{ route('pengusul.usulan.update',[$usulan->id]) }}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="col-md-12">
                        <div class="form-group col-md-4">
                            ...
                            <select name="jenis_kegiatan" class="form-control" id="jenis_kegiatan" style="font-size:13px;">
                                ...
                                <option value="penelitian" {{ $usulan->jenis_kegiatan == "penelitian" ? 'selected' : '' }}>Penelitian</option>
                                <option value="pengabdian" {{ $usulan->jenis_kegiatan == "pengabdian" ? 'selected' : '' }}>Pengabdian</option>
                            </select>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select name="skim_id" id="skim_id1" class="form-control" style="font-size:13px;">
                                ...
                                @foreach ($skims as $skim)
                                    <option value=" {{ $skim->id }}" {{ $skim->id == $usulan->skim_id ? 'selected' : '' }}> {{ $skim->nm_skim }} </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="kata_kunci" value="{{ $usulan->kata_kunci }}" class="tags form-control" />
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <textarea name="judul_kegiatan" cols="30" rows="3" class="form-control"> {{ $usulan->judul_kegiatan }} </textarea>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <textarea name="luaran" class="form-control" cols="30" rows="3">{{ $usulan->luaran }}</textarea>
                            @if ($errors->has('luaran'))
                                <small class="form-text text-danger">{{ $errors->first('luaran') }}</small>
                            @endif
                        </div>
                        <div class="form-group col-md-12">
                            <label for="exampleInputEmail1">Ringkasan (abstrak)</label>
                            <textarea name="abstrak" id="abstrak" class="form-control" cols="30" rows="10">{{ $usulan->abstrak }}</textarea>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="tujuan" id="tujuan" class="form-control" cols="30" rows="10">{{ $usulan->tujuan }}</textarea>
                        ...
                        <div class="form-group col-md-6">
                            <label for="exampleInputEmail1">Biaya Yang Diusulkan : <a class="text-danger">harap masukan angka tanpa titik dan koma</a> </label>
                            <input type="number" name="biaya_diusulkan" value="{{ $usulan->biaya_diusulkan }}" class="form-control">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <small class="form-text text-danger">File lama : {{ $usulan->file_usulan }}</small>
