                                            ...
                                            @if (empty($sudah['id']))
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <a class="btn btn-primary btn-sm" href="{{ asset('upload/file_usulan/'.\Str::slug($usulan->nm_ketua_peneliti).'-'.$usulan->ketua_peneliti_nip.'/'.$usulan->file_usulan) }}" download="{{ $usulan->file_usulan }}"><i class="fa fa-download"></i></a>
