...
<li
    ...
    @endif
>
    <a href=" {{ route('reviewer.menunggu') }} "><i class="fa fa-check-circle"></i>Review Usulan Kegiatan</a>
</li>
...
<li
    ...
    @endif
>
    <a href=" {{ route('reviewer.riwayat') }} "><i class="fa fa-history"></i>Riwayat Review</a>
</li>
